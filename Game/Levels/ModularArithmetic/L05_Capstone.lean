...
Next: **Matrix Algebra World**. Modular arithmetic gives us one algebraic
structure (a commutative ring); matrices give us a much richer,
*non-commutative* one — the setting UOV and MinRank actually live in.
"
